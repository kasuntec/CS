    ...
    $.ajax({
        ...
        success: function (data, textStatus, jqXHR) {
            ...
            $(json).each(function (index) {
                ...
                var row = [item.itemId,item.description,item.category, item.uom , item.unitPrice, item.remarks,editBtn];
    ...
    $.ajax({
        ...
        success: function (data, textStatus, jqXHR) {
            ...
            if (response.status == "ok") {//check response
                ...
                $("#category").select2("val",item.category);
                $("#uom").select2("val",item.uom);
...
function loadItemList(itemId) {
    ...
    $.ajax({
        type: 'GET',
        url: "../finished_item/name_list.htm",
        success: function (data, textStatus, jqXHR) {
