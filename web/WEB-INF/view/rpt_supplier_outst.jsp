        ...
        <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <h3 class="fg-darkBlue" > <span class="glyphicon glyphicon-th-list" ></span> Supplier Outstanding Report
                        ...
                        <div class="panel panel-primary" id="list">
                            ...
                            <div class="panel panel-body" id="print">
                                <form action="supp_outst.htm" method="post">                                   
                                    <div class="row">
                                ...
                                <table id="tbl_rpt" class="table table-responsive">
                                    ...
                                    <tbody>
                                        <c:forEach var="report" items="${outsReports}">
                                             <tr>
                                            <td>${report.supId}</td>
