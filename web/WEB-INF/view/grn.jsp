...
<html>
    <head>
        ...
        <title>Good Receive Note (GRN)</title>
        <!--CSS-->
        ...
        <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">                       
                        <h3 class="fg-darkBlue" > <span class="glyphicon glyphicon-th-list" ></span> Good Receive Note (GRN)
                        ...
                        <div class="panel panel-info" id="list">
                            <div class="panel panel-heading">
                                Good Receive Note (GRN) Information
                            </div>
                                    ...
                                    <form id="frm_grn" name="frm_issue">
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <input class="col-md-3 form-control input-sm" type="text" name="grnNo" id="grnNo" value="New" readonly="true" />
                                                </div> 
                                            </div>  
                                            <br>
                                        </div><!--Row-->
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <label class="col-md-3 text-right">Supplier</label>
                                                <div class="col-md-7">
                                                    <select class="form-control input-sm" id="supplier" name="supplier"></select>                                             
                                                </div> 
                                            </div>  
                                            <br>
                                        </div><!--Row-->
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input class="col-md-4 form-control input-sm" type="text" name="date" id="date"  data-validation="required" placeholder="YYYY-MM-dd"/>                                            
                                                </div>                                            
                                            </div>  
                                            <br>
                                        </div><!--Row-->    
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <label class="col-md-3 text-right">Tax GRN</label>
                                                <div class="col-md-1">
                                                    <input class="col-md-3 form-control input-sm" type="checkbox" name="tax" id="tax"  />                                            
                                                </div>                                            
                                            </div>  
                                            <br>
                                        </div><!--Row-->    
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <label class="col-md-3 text-right">Supp-Bill No</label>
                                                <div class="col-md-3">
                                                    <input class="col-md-3 form-control input-sm" type="text" name="refNo" id="refNo" placeholder="Ref-No" />                                            
                                                </div>                                            
                                            </div>  
                                            <br>
                                        </div><!--Row-->
                                        ...
                                        <div class="panel panel-body no-padding-bottom no-padding-top no-padding-left no-padding-right">
                                            <div class="col-md-8">
                                                <h4 class="fg-gray">
                                                    <p>Gross Total</p>                                                   
                                                    <p>Discount Value</p>    
                                                    <p>NBT Value <span id="nbtRate">%</span></p>  
                                                    <p>Vat Value <span id="vatRate">%</span></p>   
                                                    <p><b>Net Total</b></p>                                                   
                                                </h4>
                                            </div>
                                            <div class="col-md-4">
                                                <h4 class="fg-gray">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group">
                                                            <input class="col-md-1 form-control input-sm text-right" type="text" name="nbtValue" id="nbtValue"/>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="form-group">
                                                            <input class="col-md-1 form-control input-sm text-right" type="text" name="vatValue" id="vatValue"/>
                                                        </div>
                                                    </div>                                               

                                                    <b><p class="text-right" id="netTotal">0.00</p></b> 
                                                </h4>
                                            </div>                                            
    ...
    <script src='<c:url value="/js/actions/grn.js"/>'></script>   
