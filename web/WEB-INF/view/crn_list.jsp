...
<html>
        ...
        <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <h3 class="fg-darkBlue" > <span class="glyphicon glyphicon-th-list" ></span> Credit Note List
                        ...
                        <div class="panel panel-primary" id="list">
                            ...
                            <div class="panel panel-body">
                                ...
                                <hr>
                                <table id="tbl_crn" class="display"></table>
                            </div>
                        </div><!--main panel div-->
    ...
    <script src='<c:url value="/js/actions/crnList.js"/>'></script>
