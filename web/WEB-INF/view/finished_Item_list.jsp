...
<html>
        ...
        <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">                       
                        <h3 class="fg-darkBlue " > <span class="glyphicon glyphicon-th-list" ></span> Finished Items
                        ...
                        <!--Add New Form-->
                        <jsp:include page="finished_Item.jsp"/>
                        <!--Add New Form-->
                    </div><!--main row-->
                </div>
            </div>
    ...
    <script src='<c:url value="/js/actions/finishedItem.js"/>'></script>   
