<div class="modal fade" id="window_supplier" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-blue fg-white">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title" id="frm_title">Create New Supplier</h4>
            </div>

            <div class="modal-body">
                <form id="frm_supplier" name="frm_supplier">
                    <div class="row">
                        <div class="form-group">
                            <label class="col-md-3 text-right">Supplier ID</label>
                            <div class="col-md-3">
                                <input class="col-md-3 form-control input-sm" type="text" name="supId" id="supId" value="0" readonly="" />
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input class=" form-control input-sm" type="text" name="name" id="name" placeholder="Supplier Name"  data-validation="required"/>
                            </div>
                        </div>                                           
                    </div><!--Row-->
                    <br/>
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input class="form-control input-sm " type="text" name="address1" id="address1" placeholder="Line 1" data-validation="required"/>
                            </div>
                            <div class="col-md-4">
                                <input class=" form-control input-sm" type="text" name="address2" id="address2" placeholder="Line 2" data-validation="required"/>
                            </div>
                        </div>                                           
                    </div><!--Row-->
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input class="form-control input-sm" type="text" name="fax" id="fax" placeholder="Fax No" data-validation="tel"/>
                            </div>
                        </div>                                           
                    </div><!--Row-->
                    <br/>
