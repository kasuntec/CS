...
<html>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">                       
                        <h3 class="fg-darkBlue" > <span class="glyphicon glyphicon-th-list" ></span> Invoice Payment
                        ...
                        <div class="panel panel-info" id="list">
                            ...
                            <div class="panel panel-body">
                                <div class="col-md-7">
                                    <jsp:include page="invoice_pay_popup.jsp"></jsp:include>
                                    </div>
        ...
        <script>
            var invoiceNoList =${invoiceNoList};
            var action = "${action}";
            var payment =${payment};
