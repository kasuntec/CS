                ...
                <form id="frm_item" name="frm_customer">
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select class="form-control input-sm" id="rawItemCategory" name="rawItemCategory.category"></select></div>
                        </div>
                    </div> <!--Row-->     
                    <br/>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input class="form-control input-sm" type="text" data-validation="required" name="cost" id="cost" placeholder="0.00" onkeypress="return isNumberKey(event)"/>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label class="col-md-3 text-right">Re-Order Level</label>
                            <div class="col-md-3">
                                <input class="form-control input-sm" type="text" data-validation="required" name="reorderLevel" id="reorderLevel" placeholder="Re-Order Level" onkeypress="return isNumberKey(event)"/>
                            </div>
