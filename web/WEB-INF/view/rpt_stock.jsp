...
<html>
    <head>
        ...
        <title>Raw Item Stock Report</title>
        <!--CSS-->
        ...
        <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <h3 class="fg-darkBlue" > <span class="glyphicon glyphicon-th-list" ></span> Raw Item Stock Report
                                ...
                                <table id="tbl_rpt" class="table table-responsive">
                                    ...
                                    <tbody>
                                        <c:forEach var="report" items="${stockReport}">
                                            ...
                                            <td>${report.uom}</td>                                           
                                            <td class="text-right"><fmt:formatNumber value="${report.stock}"  type="number"/></td>                                           
                                            <td class="text-right"><fmt:formatNumber value="${report.cost}"  type="number"/></td>                                           
                                            <td class="text-right"><fmt:formatNumber value="${report.cost*report.stock}"  type="number"/></td>  
                                             <c:set var="sumTotal" value="${sumTotal+(report.cost*report.stock)}"/><!--set total-->
