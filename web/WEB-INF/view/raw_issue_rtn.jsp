...
<html>
    <head>
        ...
        <title>Raw Item Issue Return </title>
        <!--CSS-->
        ...
        <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">                       
                        <h3 class="fg-darkBlue" > <span class="glyphicon glyphicon-th-list" ></span> Raw Item Issue Return
                        ...
                        <div class="panel panel-info" id="list">
                            <div class="panel panel-heading">
                                Raw Item Issue Return Information
                            </div>
                            <div class="panel panel-body">
                                <div class="col-md-8">
                                    <form id="frm_issue" name="frm_issue">
                                        <div class="row">
                                            <div class="form-group">
                                                <label class="col-md-3 text-right">Return No</label>
                                                <div class="col-md-2">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <select class="form-control input-sm" id="issueNo" name="rawItemIssue.issueNo"></select>                                             
                                                </div> 
                                            </div>  
                                            <br>
                                        </div><!--Row-->
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <input class="col-md-3 form-control input-sm" type="text" name="rtn_date" id="date"  data-validation="required" placeholder="YYYY-MM-dd"/>                                            
                                                </div>                                            
                                            </div>  
                                            <br>
                                        </div><!--Row-->    
    ...
    <script>
        ...
        var issueNoList =${issueNoList};        
        var action = "${action}";
        var itemIssueRtn =${itemIssueRtn};
    ...
    <script src='<c:url value="/js/actions/rawIssueRtn.js"/>'></script>   
