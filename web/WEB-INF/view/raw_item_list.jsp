...
<html>
        ...
        <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">                       
                        <h3 class="fg-darkBlue " > <span class="glyphicon glyphicon-th-list" ></span> Raw Items
                        ...
                        <div class="panel panel-primary" id="list">
                            ...
                            <div class="panel panel-body">
                                <table id="tbl_item"></table>
                            </div>
                        </div><!--main panel div-->

                        <!--Add New Form-->
                        <jsp:include page="raw_item.jsp"/>
                        <!--Add New Form-->
                    </div><!--main row-->
                </div>
            </div>
    ...
    <script src='<c:url value="/js/actions/rawItem.js"/>'></script>   
