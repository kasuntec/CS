...
<html>
        ...
        <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <h3 class="fg-darkBlue" > <span class="glyphicon glyphicon-th-list" ></span> Invoice Payment List
                        ...
                        <div class="panel panel-primary" id="list">
                            ...
                            <div class="panel panel-body">
                                ...
                                <hr>
                                <table id="tbl_payment" class="display"></table>
                            </div>
                        </div><!--main panel div-->
    ...
    <script src='<c:url value="/js/actions/invoicePayList.js"/>'></script>
    <script src='<c:url value="/js/actions/invoicePayment.js"/>'></script>
