        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="text" class="form-control col-md-3 input-sm" id="payId" name="payId" readonly="" value="New"/>                                        
                    </div>
                </div>
                <br>
            </div>
            ...
            <div class="row" >   
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <select id="invoice" name="invoice" class="form-control input-sm" data-validation="required">                                           
            ...
            <div class="row" id="rowRefNo">
                <div class="form-group">
                    <label class="col-md-4 text-right" id="lbl_RefNo">Ref No(Optional)</label>
                    <div class="col-md-6">
