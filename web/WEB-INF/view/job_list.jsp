...
<html>
    <head>
        ...
        <title>Customers's Job List</title>
        <!--CSS-->
        ...
        <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <h3 class="fg-darkBlue" > <span class="glyphicon glyphicon-th-list" ></span> Customer Job List
                            ...
                            <div class="panel panel-body">
                                <div class="row">
                                    <div class="form-group">
                                        <label class="col-md-2 text-right ">JOB Status</label>
                                        <div class="col-md-3">
                                ...
                                <hr>
                                <table id="tbl_job" class="display"></table>
                            </div>
                        </div><!--main panel div-->
    ...
    <script src='<c:url value="/js/actions/jobList.js"/>'></script>
